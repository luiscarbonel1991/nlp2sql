...
from ..ports.schema_strategy import SchemaStrategyPort, SchemaChunk, SchemaContext
from ..core.entities import SchemaElement, DatabaseType
        ...
        if element_type == 'table' and 'columns' in schema_element:
            ...
            if column_scores:
                ...
                if avg_column_score > 0.3:
                    ...
                    reasons.append(f"Relevant columns found")
