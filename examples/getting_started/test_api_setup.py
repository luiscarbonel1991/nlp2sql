...
import asyncio
import os
from nlp2sql import create_and_initialize_service, generate_sql_from_db, DatabaseType
...
async def test_simple_sql_generation(api_key: str = None):
    """Test simple SQL generation with a mock schema."""
    ...
    try:
        # Use a simple PostgreSQL connection string for testing
        # This doesn't need to connect to a real database for basic testing
        database_url = "postgresql://test:test@localhost/test"
        
        print("📝 Testing question: 'Show me all active users'")
        
        # This will test the API key without needing a real database
        # The service creation will validate the API key
...
async def run_comprehensive_test():
    ...
    tests = [
        ...
        ("Simple SQL Generation", lambda: test_simple_sql_generation()),
