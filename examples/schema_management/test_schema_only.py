...
async def test_schema_intelligence():
    ...
    try:
        ...
        print(f"📊 Found {len(tables)} tables in Odoo database")
        
        # Test cached embeddings
        print("\n🧠 Testing Schema Embedding Manager...")
        embedding_manager = SchemaEmbeddingManager()
        ...
        search_patterns = ["user", "partner", "product", "invoice", "company"]
        ...
        print("\n💡 Next steps:")
        print("   - Update your OpenAI API key")
        print("   - Run full AI-powered query generation")
